...
% Druckversion
% fŸr reine pdf-Dateien noch Option colorlinks hinzufgen, um Links farbig zumachen
...
\lstset{keywords=[6]{thermostat,part,inter,integrate,rescale_velocities,code_info,save_sim,writepdb,analyze,uwerr, lbnode, lb_boundary, lbfluid}}
